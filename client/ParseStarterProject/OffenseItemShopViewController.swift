...
//    }
    ...
    override func viewDidLoad() {
        ...
        let tap: UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(OffenseItemShopViewController.dismissKeyboard))
        view.addGestureRecognizer(tap)
        
        //set labels
        self.headerLabel.text = "current funds - $\(currentFunds)"
            print(itemPrices)
        let item1PriceTemp = itemPrices[0] as? Int
    ...
    @IBAction func item9Button(_ sender: AnyObject) {
        if slot1Powerup != 0 && slot2Powerup != 0 && slot3Powerup != 0 {
            ...
            if slot1Powerup == 0 {
                slot1Powerup = 9
                powerup1Slot.setImage(UIImage(named:"heal.png"), for: UIControlState())
            }
            else if slot2Powerup == 0 {
                slot2Powerup = 9
                powerup2Slot.setImage(UIImage(named:"heal.png"), for: UIControlState())
            }
            else if slot3Powerup == 0 {
                slot3Powerup = 9
                powerup3Slot.setImage(UIImage(named:"heal.png"), for: UIControlState())
            }
    ...
    @IBAction func item10Button(_ sender: AnyObject) {
        if slot1Powerup != 0 && slot2Powerup != 0 && slot3Powerup != 0 {
            ...
            if slot1Powerup == 0 {
                slot1Powerup = 10
                powerup1Slot.setImage(UIImage(named:"superheal.png"), for: UIControlState())
            }
            else if slot2Powerup == 0 {
                slot2Powerup = 10
                powerup2Slot.setImage(UIImage(named:"superheal.png"), for: UIControlState())
            }
            else if slot3Powerup == 0 {
                slot3Powerup = 10
                powerup3Slot.setImage(UIImage(named:"superheal.png"), for: UIControlState())
            }
    ...
    @IBAction func item11Button(_ sender: AnyObject) {
        if slot1Powerup != 0 && slot2Powerup != 0 && slot3Powerup != 0 {
            ...
            if slot1Powerup == 0 {
                slot1Powerup = 11
                powerup1Slot.setImage(UIImage(named:"shield.png"), for: UIControlState())
            }
            else if slot2Powerup == 0 {
                slot2Powerup = 11
                powerup2Slot.setImage(UIImage(named:"shield.png"), for: UIControlState())
            }
            else if slot3Powerup == 0 {
                slot3Powerup = 11
                powerup3Slot.setImage(UIImage(named:"shield.png"), for: UIControlState())
            }
    ...
    @IBAction func item12Button(_ sender: AnyObject) {
        if slot1Powerup != 0 && slot2Powerup != 0 && slot3Powerup != 0 {
            ...
            if slot1Powerup == 0 {
                slot1Powerup = 12
                powerup1Slot.setImage(UIImage(named:"ghost.png"), for: UIControlState())
            }
            else if slot2Powerup == 0 {
                slot2Powerup = 12
                powerup2Slot.setImage(UIImage(named:"ghost.png"), for: UIControlState())
            }
            else if slot3Powerup == 0 {
                slot3Powerup = 12
                powerup3Slot.setImage(UIImage(named:"ghost.png"), for: UIControlState())
            }
